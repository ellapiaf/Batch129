...
//Example 1: 11'den 14'e kadar tum tamsayilari ekrana yazdiran kodu yaziniz.
        for(    int i=11 ;   i>14   ;  i++ ){
            System.out.println(i);
        }
        //Example 3: 40'den 23'e kadar tum  cift tamsayilari ekrana yazdiran kodu yaziniz.
     for(int i=40 ; i>22 ; i--){
     ...
     //Example 4: 18'den 56'e kadar tum   tamsayilari ekrana yazdiran kodu yaziniz.
        for(int i=18 ; i<57 ; i++){

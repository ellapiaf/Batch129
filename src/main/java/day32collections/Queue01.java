...
/*
 ...
 "Queue" larda ilk gelen ilk isleme girer.(Fisrt In First Out==>FIFO)
 Bazen de son gelen ilk isleme girer.(Last In First Out==>LIFO)
  "Deque" "Double Ended Queue" hem "FIFO" HEM DE "LIFO" icin kullanilir.

  "Queue" bir interface'dir bu yuzden "constructor" i yoktur bu yuznden  object olustururken "new" keyword'unden sonra kullanilamaz
  Data Type'i "Queue" olan bir object olusturmak icin "new" keyword'unden sonra i) LinkedList ii)PriorityQueue Class'lari kullanilabilir.
